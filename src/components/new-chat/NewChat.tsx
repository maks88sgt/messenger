  ...
  return <Modal isOpen={modalIsOpen} onClose={() => null}>
    ...
    <ModalContent sx={{ width: '40vw', height: '50vh' }}>
      ...
      <ModalBody>
        ...
        <UsersList addUser={addUser} deleteUser={deleteUser} selectedUsers={selectedUsers}/>
      </ModalBody>

      <ModalFooter>
        <Button colorScheme='cyan' variant={'outline'} mr={3}
        ...
        <Button colorScheme='cyan' onClick={async ()=>{
          if (selectedUsers.length && newChatName) {
            ...
            setChatNameError(true);
            setChatNameErrorMessage("Chat name and list of users shouldn't be empty")
          }
        }
        }>Add chat</Button>
      </ModalFooter>
